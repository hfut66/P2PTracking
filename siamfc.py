...
class SiamFC(nn.Module):
    ...
    def __init__(self):
        ...
        self.feature = nn.Sequential(
            ...
            nn.MaxPool2d(3, 2),
            # conv2
            nn.Conv2d(96, 256, 5, 1, groups=2), # groups
    ...
    def forward(self, z, x):
        ...
        n, c, h, w = x.size()       #  (batchSize, channels, height, width)
        x = x.view(1, n * c, h, w)
...
class TrackerSiamFC(Tracker):
    ...
    def _crop_and_resize(self, image, center, size, out_size, pad_color):
        ...
        # crop image patch
        corners = (corners + npad).astype(int) #corner = （y_min, x_min, y_max, x_max）
    ...
    def init(self, image, box):
        ...
        # search scale factors    return  1.0375 **（-1.5,0,1.5）
